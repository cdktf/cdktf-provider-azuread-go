...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azuread/2.44.0/docs/resources/app_role_assignment azuread_app_role_assignment}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/2.44.0/docs/resources/app_role_assignment azuread_app_role_assignment} Resource.
...
// Experimental.
func AppRoleAssignment_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAppRoleAssignment_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AppRoleAssignment_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAppRoleAssignment_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AppRoleAssignment) AddMoveTarget(moveTarget *string) {
