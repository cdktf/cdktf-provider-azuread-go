...
func (d *jsiiProxy_DataAzureadApplicationOptionalClaimsSaml2TokenList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzureadApplicationOptionalClaimsSaml2TokenList) Resolve(context cdktf.IResolveContext) interface{} {
