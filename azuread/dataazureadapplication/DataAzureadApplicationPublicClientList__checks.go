...
func (d *jsiiProxy_DataAzureadApplicationPublicClientList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataAzureadApplicationPublicClientList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
