...
func (d *jsiiProxy_DataAzureadApplicationAppRolesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataAzureadApplicationAppRolesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
