...
func (d *jsiiProxy_DataAzureadApplicationRequiredResourceAccessList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataAzureadApplicationRequiredResourceAccessList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
