...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azuread/2.46.0/docs/data-sources/application azuread_application}.
...
func (j *jsiiProxy_DataAzureadApplication) ApplicationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationId",
...
func (j *jsiiProxy_DataAzureadApplication) ApplicationIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/2.46.0/docs/data-sources/application azuread_application} Data Source.
...
func (j *jsiiProxy_DataAzureadApplication)SetApplicationId(val *string) {
...
func (d *jsiiProxy_DataAzureadApplication) ResetApplicationId() {
	_jsii_.InvokeVoid(
		d,
		"resetApplicationId",
		nil, // no parameters
