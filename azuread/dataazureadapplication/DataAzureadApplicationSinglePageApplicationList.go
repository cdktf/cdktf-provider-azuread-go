...
func (d *jsiiProxy_DataAzureadApplicationSinglePageApplicationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzureadApplicationSinglePageApplicationList) Resolve(context cdktf.IResolveContext) interface{} {
