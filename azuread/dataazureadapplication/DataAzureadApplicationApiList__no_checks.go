...
func (d *jsiiProxy_DataAzureadApplicationApiList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataAzureadApplicationApiList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
