...
func (d *jsiiProxy_DataAzureadApplicationSinglePageApplicationList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataAzureadApplicationSinglePageApplicationList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
