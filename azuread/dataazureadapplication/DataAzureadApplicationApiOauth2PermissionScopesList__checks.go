...
func (d *jsiiProxy_DataAzureadApplicationApiOauth2PermissionScopesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataAzureadApplicationApiOauth2PermissionScopesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
