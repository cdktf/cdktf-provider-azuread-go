...
func (d *jsiiProxy_DataAzureadApplicationWebImplicitGrantList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzureadApplicationWebImplicitGrantList) Resolve(context cdktf.IResolveContext) interface{} {
