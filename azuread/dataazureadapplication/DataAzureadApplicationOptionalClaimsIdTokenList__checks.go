...
func (d *jsiiProxy_DataAzureadApplicationOptionalClaimsIdTokenList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataAzureadApplicationOptionalClaimsIdTokenList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
