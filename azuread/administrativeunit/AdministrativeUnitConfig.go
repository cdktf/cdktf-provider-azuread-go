...
type AdministrativeUnitConfig struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/2.40.0/docs/resources/administrative_unit#id AdministrativeUnit#id}.
	//
