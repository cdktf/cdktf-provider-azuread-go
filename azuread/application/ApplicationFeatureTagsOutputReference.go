...
func (a *jsiiProxy_ApplicationFeatureTagsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationFeatureTagsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
