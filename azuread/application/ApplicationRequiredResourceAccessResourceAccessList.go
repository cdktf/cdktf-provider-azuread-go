...
type ApplicationRequiredResourceAccessResourceAccessList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) ApplicationRequiredResourceAccessResourceAccessOutputReference
...
// The jsii proxy struct for ApplicationRequiredResourceAccessResourceAccessList
type jsiiProxy_ApplicationRequiredResourceAccessResourceAccessList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ApplicationRequiredResourceAccessResourceAccessList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ApplicationRequiredResourceAccessResourceAccessList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ApplicationRequiredResourceAccessResourceAccessList) InternalValue() interface{} {
...
func (j *jsiiProxy_ApplicationRequiredResourceAccessResourceAccessList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ApplicationRequiredResourceAccessResourceAccessList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ApplicationRequiredResourceAccessResourceAccessList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (a *jsiiProxy_ApplicationRequiredResourceAccessResourceAccessList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationRequiredResourceAccessResourceAccessList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_ApplicationRequiredResourceAccessResourceAccessList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (a *jsiiProxy_ApplicationRequiredResourceAccessResourceAccessList) ToString() *string {
	var returns *string
