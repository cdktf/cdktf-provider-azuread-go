...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServicePrincipalTokenSigningCertificate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azuread.servicePrincipalTokenSigningCertificate.ServicePrincipalTokenSigningCertificateConfig",
		reflect.TypeOf((*ServicePrincipalTokenSigningCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azuread.servicePrincipalTokenSigningCertificate.ServicePrincipalTokenSigningCertificateTimeouts",
		reflect.TypeOf((*ServicePrincipalTokenSigningCertificateTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServicePrincipalTokenSigningCertificateTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
