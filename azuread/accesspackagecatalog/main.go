...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "externallyVisibleInput", GoGetter: "ExternallyVisibleInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExternallyVisible", GoMethod: "ResetExternallyVisible"},
