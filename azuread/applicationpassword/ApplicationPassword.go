...
func (j *jsiiProxy_ApplicationPassword) ApplicationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationId",
...
func (j *jsiiProxy_ApplicationPassword) ApplicationIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationIdInput",
...
func (j *jsiiProxy_ApplicationPassword)SetApplicationId(val *string) {
...
func ApplicationPassword_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApplicationPassword_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApplicationPassword) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApplicationPassword) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApplicationPassword) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApplicationPassword) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApplicationPassword) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApplicationPassword) MoveToId(id *string) {
...
func (a *jsiiProxy_ApplicationPassword) ResetApplicationId() {
	_jsii_.InvokeVoid(
		a,
		"resetApplicationId",
		nil, // no parameters
...
func (a *jsiiProxy_ApplicationPassword) ResetApplicationObjectId() {
	_jsii_.InvokeVoid(
		a,
		"resetApplicationObjectId",
		nil, // no parameters
...
func (a *jsiiProxy_ApplicationPassword) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApplicationPassword) ToHclTerraform() interface{} {
	var returns interface{}
