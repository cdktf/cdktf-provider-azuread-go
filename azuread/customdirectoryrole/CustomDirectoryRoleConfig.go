...
type CustomDirectoryRoleConfig struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/2.40.0/docs/resources/custom_directory_role#id CustomDirectoryRole#id}.
	//
