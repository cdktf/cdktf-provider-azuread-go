...
type CustomDirectoryRoleTimeoutsOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for CustomDirectoryRoleTimeoutsOutputReference
type jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) Create() *string {
	var returns *string
	_jsii_.Get(
		j,
		"create",
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) CreateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createInput",
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) Delete() *string {
	var returns *string
	_jsii_.Get(
		j,
		"delete",
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) DeleteInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deleteInput",
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) Read() *string {
	var returns *string
	_jsii_.Get(
		j,
		"read",
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) ReadInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"readInput",
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) Update() *string {
	var returns *string
	_jsii_.Get(
		j,
		"update",
...
func (j *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) UpdateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateInput",
...
func NewCustomDirectoryRoleTimeoutsOutputReference_Override(c CustomDirectoryRoleTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (c *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (c *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) ResetCreate() {
	_jsii_.InvokeVoid(
		c,
		"resetCreate",
		nil, // no parameters
...
func (c *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) ResetDelete() {
	_jsii_.InvokeVoid(
		c,
		"resetDelete",
		nil, // no parameters
...
func (c *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) ResetRead() {
	_jsii_.InvokeVoid(
		c,
		"resetRead",
		nil, // no parameters
...
func (c *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) ResetUpdate() {
	_jsii_.InvokeVoid(
		c,
		"resetUpdate",
		nil, // no parameters
...
func (c *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_CustomDirectoryRoleTimeoutsOutputReference) ToString() *string {
	var returns *string
