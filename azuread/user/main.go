...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "employeeHireDateInput", GoGetter: "EmployeeHireDateInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEmployeeHireDate", GoMethod: "ResetEmployeeHireDate"},
