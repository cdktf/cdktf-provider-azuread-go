...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azuread/3.2.0/docs/resources/directory_role_assignment azuread_directory_role_assignment}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.2.0/docs/resources/directory_role_assignment azuread_directory_role_assignment} Resource.
...
func DirectoryRoleAssignment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDirectoryRoleAssignment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DirectoryRoleAssignment) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DirectoryRoleAssignment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DirectoryRoleAssignment) ToHclTerraform() interface{} {
	var returns interface{}
