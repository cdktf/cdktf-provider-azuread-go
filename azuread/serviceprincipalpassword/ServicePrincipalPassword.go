...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azuread/3.1.0/docs/resources/service_principal_password azuread_service_principal_password}.
...
func (j *jsiiProxy_ServicePrincipalPassword) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.1.0/docs/resources/service_principal_password azuread_service_principal_password} Resource.
...
func (j *jsiiProxy_ServicePrincipalPassword)SetCount(val interface{}) {
...
func ServicePrincipalPassword_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServicePrincipalPassword_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func ServicePrincipalPassword_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateServicePrincipalPassword_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ServicePrincipalPassword_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateServicePrincipalPassword_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_ServicePrincipalPassword) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServicePrincipalPassword) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_ServicePrincipalPassword) ToHclTerraform() interface{} {
	var returns interface{}
