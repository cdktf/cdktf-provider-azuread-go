...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "apiClientId", GoGetter: "ApiClientId"},
			_jsii_.MemberProperty{JsiiProperty: "apiClientIdInput", GoGetter: "ApiClientIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetScopeIds", GoMethod: "ResetScopeIds"},
			...
			_jsii_.MemberProperty{JsiiProperty: "scopeIds", GoGetter: "ScopeIds"},
			_jsii_.MemberProperty{JsiiProperty: "scopeIdsInput", GoGetter: "ScopeIdsInput"},
