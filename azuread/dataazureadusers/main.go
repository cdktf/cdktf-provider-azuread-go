...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "mails", GoGetter: "Mails"},
			_jsii_.MemberProperty{JsiiProperty: "mailsInput", GoGetter: "MailsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMails", GoMethod: "ResetMails"},
