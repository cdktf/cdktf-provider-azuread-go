...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUsersList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUsersList) InternalValue() interface{} {
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUsersList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUsersList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUsersList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUsersList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUsersList)SetWrapsSet(val *bool) {
...
func (c *jsiiProxy_ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUsersList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUsersList) Get(index *float64) ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUsersOutputReference {
	if err := c.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUsersOutputReference
...
func (c *jsiiProxy_ConditionalAccessPolicyConditionsUsersExcludedGuestsOrExternalUsersList) ToString() *string {
	var returns *string
