...
func (c *jsiiProxy_ConditionalAccessPolicyGrantControlsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConditionalAccessPolicyGrantControlsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
