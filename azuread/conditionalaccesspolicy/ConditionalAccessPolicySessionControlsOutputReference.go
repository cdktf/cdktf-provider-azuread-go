...
func (c *jsiiProxy_ConditionalAccessPolicySessionControlsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConditionalAccessPolicySessionControlsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
