...
// The jsii proxy struct for ConditionalAccessPolicyConditionsDevicesOutputReference
type jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) Filter() ConditionalAccessPolicyConditionsDevicesFilterOutputReference {
	var returns ConditionalAccessPolicyConditionsDevicesFilterOutputReference
	_jsii_.Get(
		j,
		"filter",
		&returns,
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) FilterInput() *ConditionalAccessPolicyConditionsDevicesFilter {
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) InternalValue() *ConditionalAccessPolicyConditionsDevices {
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (c *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (c *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) ResetFilter() {
	_jsii_.InvokeVoid(
		c,
		"resetFilter",
		nil, // no parameters
...
func (c *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_ConditionalAccessPolicyConditionsDevicesOutputReference) ToString() *string {
	var returns *string
