...
func (s *jsiiProxy_ServicePrincipalAppRolesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServicePrincipalAppRolesList) Resolve(context cdktf.IResolveContext) interface{} {
