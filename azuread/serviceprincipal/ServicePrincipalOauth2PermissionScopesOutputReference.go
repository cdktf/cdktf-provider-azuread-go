...
func (s *jsiiProxy_ServicePrincipalOauth2PermissionScopesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServicePrincipalOauth2PermissionScopesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
