...
func (s *jsiiProxy_ServicePrincipalOauth2PermissionScopesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServicePrincipalOauth2PermissionScopesList) Resolve(context cdktf.IResolveContext) interface{} {
