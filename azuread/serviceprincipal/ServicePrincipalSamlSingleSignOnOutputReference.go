...
type ServicePrincipalSamlSingleSignOnOutputReference interface {
	cdktf.ComplexObject
	...
	// Experimental.
	Fqn() *string
	InternalValue() *ServicePrincipalSamlSingleSignOn
	SetInternalValue(val *ServicePrincipalSamlSingleSignOn)
	RelayState() *string
...
// The jsii proxy struct for ServicePrincipalSamlSingleSignOnOutputReference
type jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) InternalValue() *ServicePrincipalSamlSingleSignOn {
...
func (j *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) RelayState() *string {
	var returns *string
	_jsii_.Get(
		j,
		"relayState",
...
func (j *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) RelayStateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"relayStateInput",
...
func (j *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (s *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (s *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) ResetRelayState() {
	_jsii_.InvokeVoid(
		s,
		"resetRelayState",
		nil, // no parameters
...
func (s *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_ServicePrincipalSamlSingleSignOnOutputReference) ToString() *string {
	var returns *string
