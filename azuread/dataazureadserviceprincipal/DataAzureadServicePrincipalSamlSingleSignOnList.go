...
func (d *jsiiProxy_DataAzureadServicePrincipalSamlSingleSignOnList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzureadServicePrincipalSamlSingleSignOnList) Resolve(context cdktf.IResolveContext) interface{} {
