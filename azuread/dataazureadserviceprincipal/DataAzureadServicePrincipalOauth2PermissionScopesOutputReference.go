...
func (d *jsiiProxy_DataAzureadServicePrincipalOauth2PermissionScopesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzureadServicePrincipalOauth2PermissionScopesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
