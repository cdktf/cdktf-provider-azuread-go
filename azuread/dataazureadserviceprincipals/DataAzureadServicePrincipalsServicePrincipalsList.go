...
func (d *jsiiProxy_DataAzureadServicePrincipalsServicePrincipalsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzureadServicePrincipalsServicePrincipalsList) Resolve(context cdktf.IResolveContext) interface{} {
