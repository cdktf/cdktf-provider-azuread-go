...
func (j *jsiiProxy_ApplicationPreAuthorized) ApplicationIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"applicationIdInput",
...
func (j *jsiiProxy_ApplicationPreAuthorized) AuthorizedClientId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authorizedClientId",
...
func (j *jsiiProxy_ApplicationPreAuthorized) AuthorizedClientIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"authorizedClientIdInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_ApplicationPreAuthorized) Connection() interface{} {
...
func (j *jsiiProxy_ApplicationPreAuthorized) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_ApplicationPreAuthorized) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ApplicationPreAuthorized) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ApplicationPreAuthorized) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ApplicationPreAuthorized) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ApplicationPreAuthorized) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ApplicationPreAuthorized) Node() constructs.Node {
...
func (j *jsiiProxy_ApplicationPreAuthorized) PermissionIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"permissionIds",
...
func (j *jsiiProxy_ApplicationPreAuthorized) PermissionIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"permissionIdsInput",
...
func (j *jsiiProxy_ApplicationPreAuthorized) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_ApplicationPreAuthorized) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_ApplicationPreAuthorized) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApplicationPreAuthorized) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApplicationPreAuthorized) Timeouts() ApplicationPreAuthorizedTimeoutsOutputReference {
	var returns ApplicationPreAuthorizedTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_ApplicationPreAuthorized) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func (j *jsiiProxy_ApplicationPreAuthorized)SetApplicationId(val *string) {
...
func (j *jsiiProxy_ApplicationPreAuthorized)SetAuthorizedClientId(val *string) {
	if err := j.validateSetAuthorizedClientIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
// Experimental.
func ApplicationPreAuthorized_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApplicationPreAuthorized_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ApplicationPreAuthorized_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateApplicationPreAuthorized_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func ApplicationPreAuthorized_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-azuread.applicationPreAuthorized.ApplicationPreAuthorized",
...
func (a *jsiiProxy_ApplicationPreAuthorized) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApplicationPreAuthorized) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApplicationPreAuthorized) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApplicationPreAuthorized) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_ApplicationPreAuthorized) MoveToId(id *string) {
...
func (a *jsiiProxy_ApplicationPreAuthorized) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_ApplicationPreAuthorized) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_ApplicationPreAuthorized) ResetTimeouts() {
	_jsii_.InvokeVoid(
		a,
		"resetTimeouts",
		nil, // no parameters
...
func (a *jsiiProxy_ApplicationPreAuthorized) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApplicationPreAuthorized) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_ApplicationPreAuthorized) ToHclTerraform() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApplicationPreAuthorized) ToMetadata() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_ApplicationPreAuthorized) ToString() *string {
	var returns *string
...
func (a *jsiiProxy_ApplicationPreAuthorized) ToTerraform() interface{} {
	var returns interface{}
