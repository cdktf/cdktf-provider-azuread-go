...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "authorizedClientId", GoGetter: "AuthorizedClientId"},
			_jsii_.MemberProperty{JsiiProperty: "authorizedClientIdInput", GoGetter: "AuthorizedClientIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAuthorizedAppId", GoMethod: "ResetAuthorizedAppId"},
			_jsii_.MemberMethod{JsiiMethod: "resetAuthorizedClientId", GoMethod: "ResetAuthorizedClientId"},
