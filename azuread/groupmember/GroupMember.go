...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azuread/2.37.2/docs/resources/group_member azuread_group_member}.
type GroupMember interface {
	...
	SetGroupObjectId(val *string)
	GroupObjectIdInput() *string
	Id() *string
	SetId(val *string)
	IdInput() *string
	// Experimental.
...
func (j *jsiiProxy_GroupMember) GroupObjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupObjectId",
...
func (j *jsiiProxy_GroupMember) GroupObjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupObjectIdInput",
...
func (j *jsiiProxy_GroupMember) MemberObjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"memberObjectId",
...
func (j *jsiiProxy_GroupMember) MemberObjectIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"memberObjectIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/2.37.2/docs/resources/group_member azuread_group_member} Resource.
