...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "includeTransitiveMembers", GoGetter: "IncludeTransitiveMembers"},
			_jsii_.MemberProperty{JsiiProperty: "includeTransitiveMembersInput", GoGetter: "IncludeTransitiveMembersInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIncludeTransitiveMembers", GoMethod: "ResetIncludeTransitiveMembers"},
