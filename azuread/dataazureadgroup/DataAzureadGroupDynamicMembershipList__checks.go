...
func (d *jsiiProxy_DataAzureadGroupDynamicMembershipList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataAzureadGroupDynamicMembershipList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
