...
type NamedLocationIpOutputReference interface {
	cdktf.ComplexObject
	...
	// Experimental.
	Fqn() *string
	InternalValue() *NamedLocationIp
	SetInternalValue(val *NamedLocationIp)
	IpRanges() *[]*string
	...
	Trusted() interface{}
	SetTrusted(val interface{})
	TrustedInput() interface{}
	// Experimental.
	ComputeFqn() *string
	// Experimental.
...
// The jsii proxy struct for NamedLocationIpOutputReference
type jsiiProxy_NamedLocationIpOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_NamedLocationIpOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_NamedLocationIpOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NamedLocationIpOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_NamedLocationIpOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NamedLocationIpOutputReference) InternalValue() *NamedLocationIp {
...
func (j *jsiiProxy_NamedLocationIpOutputReference) IpRanges() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ipRanges",
...
func (j *jsiiProxy_NamedLocationIpOutputReference) IpRangesInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"ipRangesInput",
...
func (j *jsiiProxy_NamedLocationIpOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_NamedLocationIpOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_NamedLocationIpOutputReference) Trusted() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"trusted",
...
func (j *jsiiProxy_NamedLocationIpOutputReference) TrustedInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"trustedInput",
...
func NewNamedLocationIpOutputReference_Override(n NamedLocationIpOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (n *jsiiProxy_NamedLocationIpOutputReference) ComputeFqn() *string {
	var returns *string
...
func (n *jsiiProxy_NamedLocationIpOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (n *jsiiProxy_NamedLocationIpOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NamedLocationIpOutputReference) ResetTrusted() {
	_jsii_.InvokeVoid(
		n,
		"resetTrusted",
		nil, // no parameters
...
func (n *jsiiProxy_NamedLocationIpOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (n *jsiiProxy_NamedLocationIpOutputReference) ToString() *string {
	var returns *string
