...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "countryLookupMethod", GoGetter: "CountryLookupMethod"},
			_jsii_.MemberProperty{JsiiProperty: "countryLookupMethodInput", GoGetter: "CountryLookupMethodInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetCountryLookupMethod", GoMethod: "ResetCountryLookupMethod"},
