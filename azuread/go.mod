// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for azuread.
...
// You can continue to use the azuread provider in your CDK for Terraform projects with newer versions of CDKTF,
// but you will need to generate the bindings locally. See https://cdk.tf/imports for details.
module github.com/cdktf/cdktf-provider-azuread-go/azuread/v14
