...
type ClaimsMappingPolicyConfig struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azuread/2.40.0/docs/resources/claims_mapping_policy#id ClaimsMappingPolicy#id}.
	//
