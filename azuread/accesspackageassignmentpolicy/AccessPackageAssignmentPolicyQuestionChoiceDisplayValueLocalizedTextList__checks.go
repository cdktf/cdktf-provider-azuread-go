...
func (a *jsiiProxy_AccessPackageAssignmentPolicyQuestionChoiceDisplayValueLocalizedTextList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
