...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azuread/3.1.0/docs/resources/access_package_assignment_policy azuread_access_package_assignment_policy} Resource.
...
func (a *jsiiProxy_AccessPackageAssignmentPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AccessPackageAssignmentPolicy) ToHclTerraform() interface{} {
	var returns interface{}
