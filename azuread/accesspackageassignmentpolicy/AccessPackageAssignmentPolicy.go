...
// Represents a {@link https://www.terraform.io/docs/providers/azuread/r/access_package_assignment_policy azuread_access_package_assignment_policy}.
...
func (j *jsiiProxy_AccessPackageAssignmentPolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/azuread/r/access_package_assignment_policy azuread_access_package_assignment_policy} Resource.
...
func (j *jsiiProxy_AccessPackageAssignmentPolicy)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
