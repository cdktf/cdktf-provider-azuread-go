...
func (a *jsiiProxy_AccessPackageAssignmentPolicyAssignmentReviewSettingsReviewerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AccessPackageAssignmentPolicyAssignmentReviewSettingsReviewerList) Resolve(context cdktf.IResolveContext) interface{} {
