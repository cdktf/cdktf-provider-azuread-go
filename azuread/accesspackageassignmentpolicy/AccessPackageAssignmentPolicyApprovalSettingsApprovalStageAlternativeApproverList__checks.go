...
func (a *jsiiProxy_AccessPackageAssignmentPolicyApprovalSettingsApprovalStageAlternativeApproverList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
